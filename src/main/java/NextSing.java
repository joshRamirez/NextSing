...
import repository.AlbumRepositoryImpl;
...
public class NextSing {
    public static void main(String[] args) {
        AlbumRepository ar = new AlbumRepositoryImpl();
        ReadAdapter databaseRead = new ReadAdapter(ar);
        ...
        System.out.println(databaseRead.getAlbum(212).toString());
